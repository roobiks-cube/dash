...
data_o: pd.DataFrame = pd.read_csv("file_orig.csv")
...
html.Div([
    ...
    dcc.Graph(id='graph8', figure=fig),  dcc.Markdown("The main idea of these bar charts is to show the counts and support the other charts, the map, the sunbursts and the treemap.", className="markdown-style"),
      ...
      dcc.Markdown("<b>Sources:</b><br>Precise description of used python code for generation of new data.", className="markdown-style2",dangerously_allow_html=True),
